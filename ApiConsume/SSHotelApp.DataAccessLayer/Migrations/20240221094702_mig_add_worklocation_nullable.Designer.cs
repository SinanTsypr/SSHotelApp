...
namespace SSHotelApp.DataAccessLayer.Migrations
{
    ...
    [Migration("20240221094702_mig_add_worklocation_nullable")]
    partial class mig_add_worklocation_nullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.AboutUs", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Room", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Service", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Staff", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SSHotelApp.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SSHotelApp.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("SSHotelApp.EntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("SSHotelApp.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("SSHotelApp.EntityLayer.Concrete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
